...
<<<<<<< HEAD
  ...
  { path: 'leaderboard', loadComponent: () => import('./leaderboard/leaderboard.page').then(m => m.LeaderboardPage) },

  { path: '', redirectTo: 'home', pathMatch: 'full' },

  { path: 'permissions', loadComponent: () => import('./permissions/permissions.page').then(m => m.PermissionsPage) },
  { path: 'geolocation-task', loadComponent: () => import('./geolocation-task/geolocation-task.page').then(m => m.GeolocationTaskPage) },
  { path: 'distance-task', loadComponent: () => import('./distance-task/distance-task.page').then(m => m.DistanceTaskPage) },
  { path: 'qr-scan-task', loadComponent: () => import('./qr-scan-task/qr-scan-task.page').then(m => m.QrScanTaskPage) },
  { path: 'sensor-task', loadComponent: () => import('./sensor-task/sensor-task.page').then(m => m.SensorTaskPage) },
  { path: 'charge-task', loadComponent: () => import('./charge-task/charge-task.page').then(m => m.ChargeTaskPage) },
  { path: 'wlan-task', loadComponent: () => import('./wlan-task/wlan-task.page').then(m => m.WlanTaskPage) },
  { path: 'result', loadComponent: () => import('./result/result.page').then(m => m.ResultPage) },
...
>>>>>>> 1b56f377cc09dd9f0dafb25b388d45419b359665
];
